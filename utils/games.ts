export const games: Game[] = [
  ...
  },
  {
    ...
    description: 'Addictive bubble popping game',
    imageUrl: '/games/falling_bubbles.png',
    category: 'Puzzle',
    slug: 'falling-bubbles',
    author: 'sagarsaija',
    gameUrl: 'https://falling-bubbles.vercel.app/',
  },
  {
    id: '10',
    title: 'VibeSail',
    description: 'Relaxing sailing simulation game',
    imageUrl: '/games/vibesail.png',
    category: 'Simulation',
    slug: 'vibesail',
    author: 'iporollo',
    gameUrl: 'https://vibesail.com',
  },
  {
    id: '11',
    title: 'WW2 Dog Fight Arena',
    description: 'Intense WW2 aerial combat simulator',
    imageUrl: '/games/ww2_dogfight.png',
    category: 'Action',
    slug: 'ww2-dogfight',
    author: 'zullo',
    gameUrl: 'https://fly.zullo.fun/',
  },
];
